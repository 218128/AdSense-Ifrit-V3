...
class Ifrit_Connector {
    ...
    public function activate() {
        ...
        $defaults = array(
            ...
            'content_receiver_enabled' => true,
            'remote_management_enabled' => false,  // Disabled by default for security
        );
    ...
    public function on_post_published($post_id, $post) {
        if (!get_option('webhooks_enabled')) return;
    ...
    public function on_post_saved($post_id, $post, $update) {
        ...
        if (!$update) return;  // New posts handled by publish hook
