...
export async function GET(request: NextRequest) {
    ...
    // Check which legal pages exist
    const slugsToCheck = ['privacy-policy', 'terms-of-service', 'about', 'contact', 'disclaimer'];
    const existing: Record<string, { exists: boolean; id?: number; url?: string }> = {};
