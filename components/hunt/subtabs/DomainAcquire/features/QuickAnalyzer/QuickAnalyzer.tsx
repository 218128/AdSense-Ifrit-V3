/**
 * QuickAnalyzer Feature Module
 * 
 * One-click domain analysis tool using extracted hooks.
 */
...
import { useDomainAnalysis } from '../../shared/hooks';
import { useProfileGeneration } from '../../shared/hooks';
...
export default function QuickAnalyzer() {
    ...
    const handleSave = async () => {
        if (result && !result.error) {
            await saveProfile(result.domain);
        }
    };
