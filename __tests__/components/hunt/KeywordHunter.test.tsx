...
describe('KeywordHunter', () => {
    beforeEach(() => {
        jest.clearAllMocks();
        mockFetch.mockReset();
        (useKeywordStore as unknown as jest.Mock).mockReturnValue(createMockStore());
    });
    ...
    describe('Rendering', () => {
        ...
        it('should show history button with count', () => {
            (useKeywordStore as unknown as jest.Mock).mockReturnValue(
                createMockStore({ history: [{ id: '1' }, { id: '2' }] })
            );
    ...
    describe('Analysis Results', () => {
        it('should display analyzed keywords', () => {
            ...
            (useKeywordStore as unknown as jest.Mock).mockReturnValue(
                createMockStore({ analyzedKeywords })
            );
    ...
    describe('Interactions', () => {
        it('should toggle history panel when button clicked', () => {
            (useKeywordStore as unknown as jest.Mock).mockReturnValue(
                createMockStore({ history: [{ id: '1', keywords: [] }] })
            );
            ...
            // (actual visibility depends on HistoryPanel implementation)
        ...
        it('should call clearCSVKeywords via CSVImporter', () => {
            ...
            // CSVImporter should be rendered with ability to clear
    ...
    describe('Disabled State', () => {
        it('should disable analyze button when disabled prop is true', () => {
            ...
            // Find button by looking for text that includes "Analyze"
    ...
    describe('Callbacks', () => {
        it('should call onSelect when Use button clicked on analyzed keyword', async () => {
            const analyzedKeywords = [
                {
                    keyword: 'test keyword',
                    source: 'csv',
            ...
            // The AnalysisResultCard should have a Use button
            // This depends on the AnalysisResultCard implementation
